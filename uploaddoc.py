...
# from llama_index.core.llms.callbacks
# import gradio
import os
# from typing_extensions import Protocol
# from typing_extensions import _Protocol

os.environ["OPENAI_API_KEY"] = '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'
...
index = construct_index("./test")
inputText = input()
print(chatbot(inputText))
